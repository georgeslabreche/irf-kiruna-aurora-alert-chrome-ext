...
If the slope value is positive then the magnetogram readings have been trending upwards from the past 1.5 hours to 1 hour ago. The badge background color corresponds to the K index. Furthemore, a notification is given when readings pass the threshold of 52000 nT for the Z component and 100 nT for the Y component. These are pretty large thresholds as this Chrome Extension is designed to notify the user of significant aurora events that recently occured rather than minor ones.
